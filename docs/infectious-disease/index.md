...
**Can a recent vaccine cause a false positive?** Yes. Modified-live vaccines (e.g., for CPV) can cause transient antigen positivity for days to weeks. Interpret results in light of vaccination history.

**Why test FeLV antigen rather than antibody?** The p27 antigen identifies *persistent* infection — the clinically relevant state. Antibody testing alone cannot distinguish recovered from persistently infected cats.
