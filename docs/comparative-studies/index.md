...
**Is FICT as sensitive as ELISA?** Yes — FICT achieves pg/ml-scale sensitivity comparable to ELISA, with correlation coefficients typically above 0.95 in method-comparison studies.

**When should I send a sample to the lab instead?** When PCR-level confirmation, a broader panel, or a diagnostic result outside the POCT menu is required. FICT and laboratory testing are complementary, not mutually exclusive.
